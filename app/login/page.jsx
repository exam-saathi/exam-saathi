...
export default function LoginPage() {
  ...
  function handleSubmit(e) {
    ...
    localStorage.setItem("examSathiStudent", JSON.stringify(student));
            ...
            <div className="mx-auto max-w-xl">
              ...
              <div className="mb-8">
                ...
                <p className="mt-2 text-sm leading-6 text-slate-500">
                  अपनी profile की जानकारी भरकर preparation शुरू करें।
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      className="w-full appearance-none rounded-2xl border border-slate-200 bg-slate-50 py-3.5 pl-11 pr-4 text-slate-700 outline-none transition focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-500/10"
                    >
                      <option value="">
                        अपनी परीक्षा चुनें
                      </option>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <select
                        ...
                        className="w-full appearance-none rounded-2xl border border-slate-200 bg-slate-50 py-3.5 pl-11 pr-3 text-sm text-slate-700 outline-none transition focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-500/10"
                      >
                        <option value="">
                          State चुनें
                        </option>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        placeholder="जिला"
                        maxLength={40}
                        className="w-full rounded-2xl border border-slate-200 bg-slate-50 py-3.5 pl-11 pr-3 text-sm outline-none transition focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-500/10"
                      />
                    </div>
                  </div>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="group flex w-full items-center justify-center gap-2 rounded-2xl bg-blue-600 px-6 py-4 font-extrabold text-white shadow-lg shadow-blue-600/20 transition hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-70"
                >
                  {loading ? (
                    "Profile तैयार हो रही है..."
                  ) : (
                    <>
              ...
              <p className="mt-6 text-center text-xs leading-5 text-slate-400">
                Continue करके आप Exam Saathi की learning experience
                शुरू करते हैं।
              </p>
